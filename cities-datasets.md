...
| openaq: Fighting air inequality through open data and community | ? | current | csv (e.g. `curl -o openaq-2019-01-01.csv https://openaq-data.s3.amazonaws.com/2019-01-01.csv`, api | https://openaq.org| 
